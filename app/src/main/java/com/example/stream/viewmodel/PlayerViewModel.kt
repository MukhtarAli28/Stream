...
import com.example.stream.ui.activity.PlayerActivity
import com.example.stream.util.CustomPlaybackState
import com.example.stream.util.createMediaItem
...
class PlayerViewModel @Inject constructor(
    ...
    private val playerParams = savedStateHandle.get<PlayerParams>(PlayerActivity.PLAYER_PARAMS_EXTRA)
